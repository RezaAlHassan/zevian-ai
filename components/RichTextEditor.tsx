...
const RichTextEditor: React.FC<RichTextEditorProps> = ({ value, onChange, placeholder, minLength = 50, onAttach }) => {
  ...
  return (
    <div className="space-y-2">
      {/* Toolbar */}
      <div className="flex items-center gap-1 p-2 bg-muted rounded-t-md border border-border border-b-0">
        <button
          type="button"
      ...
      <div
        ...
        className="min-h-[200px] bg-muted border border-border rounded-b-md px-3 py-2 text-foreground focus:ring-2 focus:ring-primary focus:border-primary transition-all outline-none"
